...
Header.Banner = function HeaderBanner({ children, ...restProps }) {
    ...
    useEffect(() => {
        async function fetchData() {
            const request = await axios.get(requests.fetchChuroChapacoOriginals);
    ...
    return (
        ...
        <div>
        <Row title="ORIGINALES DE CHURO CHAPACO" fetchUrl={requests.fetchChuroChapacoOriginals}
            isLargeRow
        />
        <Row title="Tendencias" fetchUrl={requests.fetchTrending} />
        <Row title="Más valoradas" fetchUrl={requests.fetchTopRated} />
        ...
        <Row title="Películas románticas" fetchUrl={requests.fetchRomanticMovies} />
